...
class Ui_Dialog_CCD(object):
    def setupUi(self, Dialog_CCD):
        ...
        self.groupBox_CCD = QtWidgets.QGroupBox(parent=Dialog_CCD)
        self.groupBox_CCD.setObjectName("groupBox_CCD")
        self.gridLayout = QtWidgets.QGridLayout(self.groupBox_CCD)
        self.gridLayout.setObjectName("gridLayout")
        self.splitter = QtWidgets.QSplitter(parent=self.groupBox_CCD)
        self.splitter.setOrientation(QtCore.Qt.Orientation.Horizontal)
        self.splitter.setObjectName("splitter")
        self.tableWidget_CCD = QtWidgets.QTableWidget(parent=self.splitter)
        ...
        self.frame_CCD = QtWidgets.QFrame(parent=self.splitter)
        self.frame_CCD.setFrameShape(QtWidgets.QFrame.Shape.StyledPanel)
        self.frame_CCD.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        ...
        self.comboBox_CCD_interface = QtWidgets.QComboBox(parent=self.frame_CCD)
        ...
        self.pushButton_CCD_Force_Interface = QtWidgets.QPushButton(parent=self.frame_CCD)
        ...
        self.label_CCD_interfaceName = QtWidgets.QLabel(parent=self.frame_CCD)
        ...
        self.pushButton_CCD_AddInterface = QtWidgets.QPushButton(parent=self.frame_CCD)
        ...
        self.pushButton_CCD_DelInterface = QtWidgets.QPushButton(parent=self.frame_CCD)
        ...
        self.groupBox_CCD_actionFiles = QtWidgets.QGroupBox(parent=self.frame_CCD)
        ...
        self.label_CCD_Command_Filestatus = QtWidgets.QLabel(parent=self.groupBox_CCD_actionFiles)
        ...
        self.tabWidget_CCD_configs.setTabPosition(QtWidgets.QTabWidget.TabPosition.West)
        ...
        self.groupBox_CCD_actionChanges = QtWidgets.QGroupBox(parent=self.tab_CCD_ActionConfig)
        ...
        self.comboBox_CCD_action = QtWidgets.QComboBox(parent=self.groupBox_CCD_actionChanges)
        ...
        self.lineEdit_CCD_action = QtWidgets.QLineEdit(parent=self.groupBox_CCD_actionChanges)
        self.lineEdit_CCD_action.setObjectName("lineEdit_CCD_action")
        self.horizontalLayout_2.addWidget(self.lineEdit_CCD_action)
        self.pushButton_CCD_actionAdd = QtWidgets.QPushButton(parent=self.groupBox_CCD_actionChanges)
        ...
        self.pushButton_CCD_actionDel = QtWidgets.QPushButton(parent=self.groupBox_CCD_actionChanges)
        ...
        self.lineEdit_CCD_Format = QtWidgets.QLineEdit(parent=self.groupBox_CCD_actionChanges)
        self.lineEdit_CCD_Format.setObjectName("lineEdit_CCD_Format")
        self.verticalLayout_5.addWidget(self.lineEdit_CCD_Format)
        self.tableWidget_CCD_actionParam = QtWidgets.QTableWidget(parent=self.groupBox_CCD_actionChanges)
        ...
        self.label_CCD_testResultFormat = QtWidgets.QLabel(parent=self.groupBox_CCD_actionChanges)
        ...
        self.pushButton_CCD_actionTest = QtWidgets.QPushButton(parent=self.groupBox_CCD_actionChanges)
        ...
        self.label_CCD_testResult = QtWidgets.QLabel(parent=self.groupBox_CCD_actionChanges)
        ...
        self.groupBox_CCD_readChanges = QtWidgets.QGroupBox(parent=self.tab_CCD_ReadConfig)
        ...
        self.comboBox_CCD_readaction = QtWidgets.QComboBox(parent=self.groupBox_CCD_readChanges)
        ...
        self.lineEdit_CCD_readaction = QtWidgets.QLineEdit(parent=self.groupBox_CCD_readChanges)
        ...
        self.pushButton_CCD_readactionAdd = QtWidgets.QPushButton(parent=self.groupBox_CCD_readChanges)
        self.pushButton_CCD_readactionAdd.setMaximumSize(QtCore.QSize(25, 25))
        self.pushButton_CCD_readactionAdd.setText("")
        self.pushButton_CCD_readactionAdd.setIcon(icon5)
        ...
        self.pushButton_CCD_readactionDel = QtWidgets.QPushButton(parent=self.groupBox_CCD_readChanges)
        self.pushButton_CCD_readactionDel.setMaximumSize(QtCore.QSize(25, 25))
        self.pushButton_CCD_readactionDel.setText("")
        self.pushButton_CCD_readactionDel.setIcon(icon6)
        ...
        self.lineEdit_CCD_readFormat = QtWidgets.QLineEdit(parent=self.groupBox_CCD_readChanges)
        ...
        self.line = QtWidgets.QFrame(parent=self.groupBox_CCD_readChanges)
        ...
        self.lineEdit_CCD_testRead_text = QtWidgets.QLineEdit(parent=self.groupBox_CCD_readChanges)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.tableWidget_CCD_readactionParam = QtWidgets.QTableWidget(parent=self.groupBox_CCD_readChanges)
        ...
        self.label_CCD_testreadResultFormat = QtWidgets.QLabel(parent=self.groupBox_CCD_readChanges)
        ...
        self.pushButton_CCD_readactionTest = QtWidgets.QPushButton(parent=self.groupBox_CCD_readChanges)
        ...
        self.label_CCD_testreadResult = QtWidgets.QLabel(parent=self.groupBox_CCD_readChanges)
        ...
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.tab_CCD_GeneralConfig)
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.groupBox_CCD_IntChanges = QtWidgets.QGroupBox(parent=self.tab_CCD_GeneralConfig)
        self.groupBox_CCD_IntChanges.setToolTip("")
        self.groupBox_CCD_IntChanges.setObjectName("groupBox_CCD_IntChanges")
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.groupBox_CCD_IntChanges)
        self.verticalLayout_6.setObjectName("verticalLayout_6")
        self.comboBox_CCD_Intaction = QtWidgets.QComboBox(parent=self.groupBox_CCD_IntChanges)
        self.comboBox_CCD_Intaction.setObjectName("comboBox_CCD_Intaction")
        self.verticalLayout_6.addWidget(self.comboBox_CCD_Intaction)
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.lineEdit_CCD_Intaction = QtWidgets.QLineEdit(parent=self.groupBox_CCD_IntChanges)
        self.lineEdit_CCD_Intaction.setObjectName("lineEdit_CCD_Intaction")
        self.horizontalLayout_4.addWidget(self.lineEdit_CCD_Intaction)
        self.pushButton_CCD_IntactionAdd = QtWidgets.QPushButton(parent=self.groupBox_CCD_IntChanges)
        self.pushButton_CCD_IntactionAdd.setMaximumSize(QtCore.QSize(25, 25))
        self.pushButton_CCD_IntactionAdd.setText("")
        self.pushButton_CCD_IntactionAdd.setIcon(icon5)
        self.pushButton_CCD_IntactionAdd.setObjectName("pushButton_CCD_IntactionAdd")
        self.horizontalLayout_4.addWidget(self.pushButton_CCD_IntactionAdd)
        self.pushButton_CCD_IntactionDel = QtWidgets.QPushButton(parent=self.groupBox_CCD_IntChanges)
        self.pushButton_CCD_IntactionDel.setMaximumSize(QtCore.QSize(25, 25))
        self.pushButton_CCD_IntactionDel.setText("")
        self.pushButton_CCD_IntactionDel.setIcon(icon6)
        self.pushButton_CCD_IntactionDel.setObjectName("pushButton_CCD_IntactionDel")
        self.horizontalLayout_4.addWidget(self.pushButton_CCD_IntactionDel)
        self.verticalLayout_6.addLayout(self.horizontalLayout_4)
        self.lineEdit_CCD_IntFormat = QtWidgets.QLineEdit(parent=self.groupBox_CCD_IntChanges)
        self.lineEdit_CCD_IntFormat.setObjectName("lineEdit_CCD_IntFormat")
        self.verticalLayout_6.addWidget(self.lineEdit_CCD_IntFormat)
        self.comboBox_CCD_Inttype = QtWidgets.QComboBox(parent=self.groupBox_CCD_IntChanges)
        self.comboBox_CCD_Inttype.setObjectName("comboBox_CCD_Inttype")
        self.verticalLayout_6.addWidget(self.comboBox_CCD_Inttype)
        self.label_CCD_testIntResultFormat = QtWidgets.QLabel(parent=self.groupBox_CCD_IntChanges)
        self.label_CCD_testIntResultFormat.setText("")
        self.label_CCD_testIntResultFormat.setObjectName("label_CCD_testIntResultFormat")
        self.verticalLayout_6.addWidget(self.label_CCD_testIntResultFormat)
        self.pushButton_CCD_IntactionTest = QtWidgets.QPushButton(parent=self.groupBox_CCD_IntChanges)
        self.pushButton_CCD_IntactionTest.setObjectName("pushButton_CCD_IntactionTest")
        self.verticalLayout_6.addWidget(self.pushButton_CCD_IntactionTest)
        self.label_CCD_testIntResult = QtWidgets.QLabel(parent=self.groupBox_CCD_IntChanges)
        self.label_CCD_testIntResult.setText("")
        self.label_CCD_testIntResult.setObjectName("label_CCD_testIntResult")
        self.verticalLayout_6.addWidget(self.label_CCD_testIntResult)
        self.verticalLayout_7.addWidget(self.groupBox_CCD_IntChanges)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(parent=Dialog_CCD)
        ...
        self.buttonBox.accepted.connect(Dialog_CCD.accept) # type: ignore
        self.buttonBox.rejected.connect(Dialog_CCD.reject) # type: ignore
...
"        When is a new Read action then is executed after all the others."))
        ...
        self.groupBox_CCD_IntChanges.setTitle(_translate("Dialog_CCD", "General Configuration"))
        self.lineEdit_CCD_Intaction.setToolTip(_translate("Dialog_CCD", "action Name Field"))
        self.pushButton_CCD_IntactionAdd.setToolTip(_translate("Dialog_CCD", "Add new action or Replace format in action"))
        self.pushButton_CCD_IntactionDel.setToolTip(_translate("Dialog_CCD", "Delete action or clear format in action"))
        self.lineEdit_CCD_IntFormat.setToolTip(_translate("Dialog_CCD", "Format Field"))
        self.comboBox_CCD_Inttype.setToolTip(_translate("Dialog_CCD", "Here the type for the configuration. If defined makes type check"))
        self.label_CCD_testIntResultFormat.setToolTip(_translate("Dialog_CCD", "Format interpretation"))
        self.pushButton_CCD_IntactionTest.setToolTip(_translate("Dialog_CCD", "Press me to test with different parameter value on table."))
        self.pushButton_CCD_IntactionTest.setText(_translate("Dialog_CCD", "Test Action"))
        self.label_CCD_testIntResult.setToolTip(_translate("Dialog_CCD", "Gcode interpretation Result"))
