...
class Ui_Dialog_VBD(object):
    def setupUi(self, Dialog_VBD):
        ...
        self.comboBox_VBD_BattonSelect = QtWidgets.QComboBox(self.groupBox_VBD_Buttons)
        self.comboBox_VBD_BattonSelect.setObjectName("comboBox_VBD_BattonSelect")
        self.horizontalLayout_2.addWidget(self.comboBox_VBD_BattonSelect)
        self.pushButton_VBD_Lock = QtWidgets.QPushButton(self.groupBox_VBD_Buttons)
        self.pushButton_VBD_Lock.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("img/Action-lock-pink-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.pushButton_VBD_Lock.setIcon(icon)
        self.pushButton_VBD_Lock.setObjectName("pushButton_VBD_Lock")
        self.horizontalLayout_2.addWidget(self.pushButton_VBD_Lock)
