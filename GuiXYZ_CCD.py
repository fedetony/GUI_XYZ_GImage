...
class Ui_Dialog_CCD(object):
    def setupUi(self, Dialog_CCD):
        ...
        self.gridLayout_2.addWidget(self.pushButton_CCD_set_commands, 1, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_CCD_interfaceName, 0, 1, 1, 1)
        self.label_test = QtWidgets.QLabel(self.frame_CCD)
        self.label_test.setObjectName("label_test")
        self.gridLayout_2.addWidget(self.label_test, 2, 0, 1, 1)
