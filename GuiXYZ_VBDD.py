...
class Ui_Dialog_VBDD(object):
    def setupUi(self, Dialog_VBDD):
        ...
        self.groupBox_VBDD_byScript = QtWidgets.QGroupBox(self.groupBox_VBDF)
        ...
        self.gridLayout.addWidget(self.groupBox_VBDD_byScript, 5, 0, 2, 1)
        self.groupBox_VBDD_byGcode = QtWidgets.QGroupBox(self.groupBox_VBDF)
        ...
        self.gridLayout.addWidget(self.groupBox_VBDD_byGcode, 4, 0, 1, 1)
