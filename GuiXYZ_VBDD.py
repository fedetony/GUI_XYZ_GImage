...
class Ui_Dialog_VBDD(object):
    def setupUi(self, Dialog_VBDD):
        ...
        self.gridLayout.addWidget(self.textEdit_VBDD_Gcode, 9, 0, 1, 1)
        ...
        self.label_VBDD_Name = QtWidgets.QLabel(self.groupBox_VBDD_byaction)
        self.label_VBDD_Name.setObjectName("label_VBDD_Name")
        self.horizontalLayout.addWidget(self.label_VBDD_Name)
        self.lineEdit_VBDD_Name = QtWidgets.QLineEdit(self.groupBox_VBDD_byaction)
        ...
        self.gridLayout.addWidget(self.groupBox_VBDD_byaction, 1, 0, 2, 1)
        self.label_VBDD_id = QtWidgets.QLabel(self.groupBox_VBDF)
        self.label_VBDD_id.setObjectName("label_VBDD_id")
        self.gridLayout.addWidget(self.label_VBDD_id, 0, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog_VBDD):
        ...
        self.label_VBDD_Format.setText(_translate("Dialog_VBDD", "TextLabel"))
        self.label_VBDD_Result.setText(_translate("Dialog_VBDD", "TextLabel"))
